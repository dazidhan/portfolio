    ...
    >
      ...
      <div className="relative z-10 max-w-4xl">
        <div className="hero-socials mb-4 flex items-center gap-6 sm:mb-5 lg:mb-6">
          <a
            href="https://github.com/dazidhan"
            target="_blank"
          ...
          <a
            href="https://linkedin.com/in/dhaffazikrullah"
            target="_blank"
            rel="noopener noreferrer"
            className="text-foreground/45 hover:text-foreground transition-colors duration-300"
            aria-label="LinkedIn"
          ...
          <a
            href="https://instagram.com/dhaffazik"
            target="_blank"
            rel="noopener noreferrer"
            className="text-foreground/45 hover:text-foreground transition-colors duration-300"
          ...
          <a
            href="mailto:dhaffazr@gmail.com"
            className="text-foreground/45 hover:text-foreground transition-colors duration-300"
            aria-label="Email"
          >
            <svg
        ...
        <h1 className="greetings mt-4 min-h-[4rem] font-serif text-[3.2rem] leading-none sm:mt-5 sm:min-h-[6rem] sm:text-7xl lg:min-h-[8rem] lg:text-[7rem] whitespace-nowrap">
          Hi, I’m <span className="italic">Dhaffa</span>
        </h1>
        <TextType
        ...
        <div className="hero-resume mt-4 flex sm:mt-5 lg:mt-6">
          <a
            href="/Dhaffa Zikrullah Ramadhan - CV ATS.pdf"
            target="_blank"
            rel="noopener noreferrer"
