...
const lines: IntroLinePart[][] = [
  [
    ...
    { text: "fullstack web applications", highlight: true },
  ],
  [
    { text: "and", highlight: false },
    { text: "robust backend systems,", highlight: true },
  ],
  [
    { text: "integrating", highlight: false },
    { text: "intelligent AI technologies", highlight: true },
  ],
  [{ text: "and reliable REST APIs to deliver", highlight: false }],
  [
    { text: "efficient and", highlight: false },
    {
...
const skills = ["Next.js", "Express.js", "Node.js", "Python", "Go", "Docker"];
  ...
  return (
    ...
    >
      <h2 id="about-heading" className="sr-only">
        About Dhaffa Zikrullah Ramadhan, Backend Developer & AI Engineer
      </h2>
