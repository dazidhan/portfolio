  ...
  "@graph": [
    {
      ...
      url: siteConfig.url,
      image: `${siteConfig.url}/dhaffa.png`,
...
const socialItems = [
  { label: "Resume", link: "/Dhaffa Zikrullah Ramadhan - CV ATS.pdf" },
  { label: "GitHub", link: "https://github.com/dazidhan" },
  { label: "LinkedIn", link: "https://linkedin.com/in/dhaffazikrullah" },
  { label: "Instagram", link: "https://instagram.com/dhaffazik" },
];
