...
export default function AnimatedProfile() {
  ...
  return (
    <div className="profile-card relative z-10 flex w-full justify-center [perspective:1200px] lg:justify-end">
      <motion.div
        ref={cardRef}
        className="relative h-[360px] w-full max-w-[280px] overflow-hidden rounded-[2rem] border border-white/18 bg-[#0b0b0d] will-change-transform sm:h-[420px] sm:max-w-[340px] lg:h-[480px] lg:max-w-[380px]"
        data-profile-card
        style={{
      ...
      >
        ...
        <Image
          src="/dhaffa.png"
          alt="Portrait of Dhaffa Zikrullah"
          fill
          priority
        ...
        <div className="absolute inset-x-5 bottom-5 z-30 flex items-center justify-between gap-4 rounded-2xl border border-white/12 bg-white/[0.075] px-5 py-4 text-white shadow-[0_16px_40px_rgba(0,0,0,0.24)] backdrop-blur-md">
          <div>
            <p className="text-sm font-semibold leading-none">@dazidhan</p>
